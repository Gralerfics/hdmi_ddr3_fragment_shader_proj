...
HD_PWD='C:/Workspace/hdmi_ddr3_fragment_shader_proj/hdmi_ddr3_fragment_shader_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_ddr3_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_ddr3_uart.tcl
