...
HD_PWD='C:/Workspace/hdmi_ddr3_fragment_shader_proj/hdmi_ddr3_fragment_shader_proj.runs/ddr3_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr3_clock.tcl
