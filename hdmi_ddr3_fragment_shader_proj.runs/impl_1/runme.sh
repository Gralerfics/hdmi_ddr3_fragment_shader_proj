...
HD_PWD='C:/Workspace/hdmi_ddr3_fragment_shader_proj/hdmi_ddr3_fragment_shader_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_ddr3_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_ddr3_uart.tcl -notrace
