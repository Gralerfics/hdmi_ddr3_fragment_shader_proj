...
HD_PWD='E:/Textbook/MicroPhase/Board_cd/A7_Lite/04_source_code/A7_lite_demo_200T/22_hdmi_ddr3_uart/hdmi_ddr3_uart.runs/ddr3_tx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_tx_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr3_tx_fifo.tcl
