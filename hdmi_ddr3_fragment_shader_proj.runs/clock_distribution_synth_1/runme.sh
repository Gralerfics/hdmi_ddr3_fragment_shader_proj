...
HD_PWD='C:/Workspace/hdmi_ddr3_fragment_shader_proj/hdmi_ddr3_fragment_shader_proj.runs/clock_distribution_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_distribution.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_distribution.tcl
