...
HD_PWD='E:/Textbook/MicroPhase/Board_cd/A7_Lite/04_source_code/A7_lite_demo_200T/22_hdmi_ddr3_uart/hdmi_ddr3_uart.runs/mig_ddr3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_ddr3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig_ddr3.tcl
