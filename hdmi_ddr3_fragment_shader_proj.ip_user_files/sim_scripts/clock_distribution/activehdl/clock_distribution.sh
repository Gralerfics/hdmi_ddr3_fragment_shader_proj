...
#                script (type 'clock_distribution.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Workspace/hdmi_ddr3_fragment_shader_proj/hdmi_ddr3_fragment_shader_proj.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
