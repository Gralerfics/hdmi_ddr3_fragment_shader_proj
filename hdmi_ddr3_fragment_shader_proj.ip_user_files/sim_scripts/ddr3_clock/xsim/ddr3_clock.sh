...
#
# Script generated by Vivado on Wed May 14 12:50:45 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ddr3_clock.sh
...
#
# Usage        : ddr3_clock.sh
#                ddr3_clock.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ddr3_clock.sh [-reset_run]
#                ddr3_clock.sh [-reset_log]
#                ddr3_clock.sh [-help]
#
...
# script info
echo -e "ddr3_clock.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ddr3_clock.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr3_clock xil_defaultlib.ddr3_clock xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ddr3_clock -key {Behavioral:sim_1:Functional:ddr3_clock} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ddr3_clock.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ddr3_clock.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ddr3_clock.sh [-help]\n\
Usage: ddr3_clock.sh [-step]\n\
Usage: ddr3_clock.sh [-lib_map_path]\n\
Usage: ddr3_clock.sh [-reset_run]\n\
Usage: ddr3_clock.sh [-reset_log]\n\
Usage: ddr3_clock.sh [-keep_index]\n\
Usage: ddr3_clock.sh [-noclean_files]\n\n\
