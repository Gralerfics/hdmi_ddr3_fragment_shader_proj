...
#
# Generated by export_simulation on Wed Oct 25 15:26:56 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './mig_ddr3.sh' script.

./mig_ddr3.sh -reset_run
...
./mig_ddr3.sh -noclean_files

For more information on the script, please type './mig_ddr3.sh -help'.
